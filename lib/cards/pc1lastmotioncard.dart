...
class Pc1LastMotionCard extends StatelessWidget {

  final String apiUrl = "http://192.168.0.26:8090/pc1_last_moving";

  Future<List<dynamic>> fetchPc1TodaysEvents() async {
    var result = await http.get(Uri.parse(apiUrl));
    // print(json.decode(result.body)['pc1_last_moving']);
    return json.decode(result.body)['pc1_last_moving'];
  }
          ...
          child: FutureBuilder<List<dynamic>>(
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              ...
              if(snapshot.hasData){
                ...
                children: <Widget>[
                  Center(
                    child: Text('PC1 MOTION', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 22.0,)),
                  ),
                  Center(
